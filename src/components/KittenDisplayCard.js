...
const KittenDisplayCard = props => {


    const [activeIndex, setIndex] = useState(-1);
    return (
        <Card>
            <Image src={`https://robohash.org/ModelNumber${props.modelNumber}.png?set=set4`} wrapped ui={false} className={props.type}/>
            <Card.Content>
...
KittenDisplayCard.defaultProps = {
...
export default KittenDisplayCard;